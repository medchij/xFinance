...
const groupedTools = [
  {
    ...
    tools: [
      ...
      { icon: <ArrowSwap16Regular />, label: "Тоог эерэг/сөрөг болгох" },
  ...
  },
  {
    ...
    tools: [
      ...
      { icon: <DocumentSettings20Regular />, label: "PS Зээлийн зориулалт, хугацаа" },
      { icon: <DataTrending16Regular />, label: "Топ 40 зээлийн тайлан" },
      { icon: <DocumentTableSearchRegular />, label: "Зээлийн данс лавлах" },
      { icon: <DocumentData20Regular />, label: "Зээлийн жагсаалт татах" },
      { icon: <PeopleList20Regular />, label: "Харилцагчийн жагсаалт татах" },
      { icon: <ReceiptSearchRegular />, label: "CIF дугаараар Depo данс лавлах" },
      { icon: <DocumentSettings20Regular />, label: "NES нэвтрэх" },
    ],
  },
  {
...
const CustomTools = ({ isSidebarOpen }) => {
  ...
  const actions = {
    ...
    "Тоог эерэг/сөрөг болгох": () => fns.handleNegativeConversion(showMessage, setLoading),
    ...
    "CIF дугаараар Depo данс лавлах": () => pfns.fetchPolarisDepoAccount(showMessage, setLoading),
    "NES нэвтрэх": () => pfns.authenticateNES(showMessage, setLoading),
